...
static inline int pte_global(pte_t pte) 	{ return __pte_val(pte) & _PAGE_GLOBAL; }
...
static inline pte_t pte_mkglobal(pte_t pte)	{ return __pte_ma(__pte_val(pte) | _PAGE_GLOBAL); }
static inline pte_t pte_clrglobal(pte_t pte)	{ return __pte_ma(__pte_val(pte) & ~(pteval_t)_PAGE_GLOBAL); }
