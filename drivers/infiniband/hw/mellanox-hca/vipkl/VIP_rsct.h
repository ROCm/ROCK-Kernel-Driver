...
VIP_ret_t VIP_RSCT_iter_init(VIP_RSCT_t usr_ctx, VIP_RSCT_rsctype_t rsc_type);
VIP_ret_t VIP_RSCT_get_cur_rsrc(VIP_RSCT_t usr_ctx, VIP_RSCT_rsctype_t rsc_type, void *rsc_hndl_p);
VIP_ret_t VIP_RSCT_get_next_rsrc(VIP_RSCT_t usr_ctx, VIP_RSCT_rsctype_t rsc_type, void *rsc_hndl_p);
