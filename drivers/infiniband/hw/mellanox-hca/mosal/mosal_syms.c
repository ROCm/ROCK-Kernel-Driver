...
EXPORT_SYMBOL(MOSAL_iobuf_restore_perm);
EXPORT_SYMBOL(MOSAL_PCI_read_config_word);
EXPORT_SYMBOL(MOSAL_PCI_write_config_word);

EXPORT_SYMBOL(MT_bufpool_create);
EXPORT_SYMBOL(MT_bufpool_alloc);
EXPORT_SYMBOL(MT_bufpool_free);
EXPORT_SYMBOL(MT_bufpool_destroy);
