...
#define MOSAL_iobuf_register(va, size, prot_ctx, req_perm, iobuf_p, flags)                                                    \
                             ({                                                                                        \
                                call_result_t rc;                                                                      \
                                rc = MOSAL_iobuf_register_memtrack(va, size, prot_ctx, req_perm, iobuf_p, flags);             \
                                if ( rc == MT_OK ) {                                                                   \
...
/******************************************************************************
 *  Function (Kernel space only): MOSAL_iobuf_restore_perm
 *
 *  Description: Restore the permissions on the page tables to the value as
