/*
  ...
  $Id: MT23108_PRM.h,v 1.1.1.1 2004/02/24 19:46:34 roland Exp $
*/

/***
 *** This file was generated at "Tue Feb 24 19:02:17 2004"
 *** by:
 ***    % csp_bf -prefix tavorprm_ -bits -fixnames MT23108_PRM.csp
 ***/
...
struct tavorprm_eq_cmd_doorbell_st {	/* Little Endian */
    ...
    pseudo_bit_t	eq_cmd[0x00008];       /* Command to be executed on EQ
                                                 ...
                                                 other - reserved */
/* -------------- */
    pseudo_bit_t	eq_param[0x00020];     /* parameter to be used by EQ command */
/* -------------- */
};
...
/* -------------- */
    pseudo_bit_t	dimm_start_adr_h[0x00020];/* DDR memory start address [63:32].  This value is valid only when DIMMStatus is 0. */
/* -------------- */
    pseudo_bit_t	dimm_start_adr_l[0x00020];/* DDR memory start address [31:0].  This value is valid only when DIMMStatus is 0. */
/* -------------- */
...
struct tavorprm_mod_stat_cfg_st {	/* Little Endian */
    ...
    pseudo_bit_t	reserved1[0x00018];
/* -------------- */
    pseudo_bit_t	tpt_map[0x00004];
    pseudo_bit_t	reserved2[0x00003];
    pseudo_bit_t	tpt_map_m[0x00001];
    pseudo_bit_t	reserved3[0x00018];
/* -------------- */
    pseudo_bit_t	reserved4[0x007c0];
/* -------------- */
};
...
/* -------------- */
    pseudo_bit_t	rq_num_wrfe[0x00020];  /* Responder - number of WR flushed errors */
/* -------------- */
    pseudo_bit_t	sq_num_wrfe[0x00020];  /* Requester - number of WR flushed errors */
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved11[0x00380];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved14[0x003e0];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved15[0x002a0];
/* -------------- */
};
...
/* -------------- */
    ...
    pseudo_bit_t	log_max_qp_sz[0x00008];/* Log2 of the maximum WQEs allowed on the RQ or the SQ */
    pseudo_bit_t	log_max_srq_sz[0x00008];/* Log2 of the maximum WQEs allowed on the SRQ */
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved2[0x00760];
/* -------------- */
};
...
/* -------------- */
    ...
    pseudo_bit_t	ap[0x00002];           /* Auto Precharge Mode
                                                 ...
                                                 11 - reserved */
    pseudo_bit_t	dh[0x00001];           /* When Set DDR is Hidden and can not be accessed from PCI bus */
...
/* -------------- */
    pseudo_bit_t	lkey[0x00020];         /* Must be 0 for SW2HW_MPT.
                                                 On QUERY_MPTand HW2SW_MPT commands for Memory Window it reflects the LKey of the Region that the Window is bound to. */
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	subsystem_vendor_id[0x00010];/* Programmed via InfiniBurn */
    pseudo_bit_t	subsystem_id[0x00010]; /* programmed via InfiniBurn */
/* -------------- */
    pseudo_bit_t	expansion_rom_base_address[0x00020];/* Programmed via InfiniBurn if expansion ROM enabled */
/* -------------- */
    pseudo_bit_t	capabilities_pointer[0x00008];/* Programmed via InfiniBurn */
    pseudo_bit_t	reserved3[0x00018];
/* -------------- */
    pseudo_bit_t	reserved4[0x00020];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved5[0x00100];
/* -------------- */
...
/* -------------- */
    ...
    pseudo_bit_t	reserved7[0x00010];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved8[0x00440];
/* -------------- */
};
...
/* -------------- */
    pseudo_bit_t	reserved32[0x7fe00];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved34[0x7ff80];
/* -------------- */
    struct tavorprm_send_doorbell_st	send_doorbell;/* Send doorbell */
/* -------------- */
    pseudo_bit_t	reserved35[0x7ffc0];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved50[0x80000];
/* -------------- */
    pseudo_bit_t	reserved51[0x00100];
/* -------------- */
    pseudo_bit_t	reserved52[0x7ff00];
/* -------------- */
    pseudo_bit_t	reserved53[0x00100];
/* -------------- */
    pseudo_bit_t	reserved54[0x7ff00];
/* -------------- */
...
/* -------------- */
    pseudo_bit_t	reserved56[0x00080];
/* -------------- */
    pseudo_bit_t	reserved57[0x00040];
/* -------------- */
    pseudo_bit_t	reserved58[0x1bff740];
/* -------------- */
};
...
struct tavorprm_scrubbing_event_st {	/* Little Endian */
    pseudo_bit_t	reserved0[0x00080];
/* -------------- */
    pseudo_bit_t	ecc_err_fifo_word1[0x00010];/* For debug: ECC error was discovered and corrected by InfiniHost */
    pseudo_bit_t	reserved1[0x0000f];
    pseudo_bit_t	overflow[0x00001];     /* Fatal: ECC error FIFO overflow - ECC errors were detected, which may or may not have been corrected by InfiiHost */
/* -------------- */
    pseudo_bit_t	ecc_err_fifo_word2[0x00020];/* For debug: ECC error was discovered and corrected by InfiniHost */
/* -------------- */
};
