...
/**********************************************************
 * 
 * Function: EVAPI_register_thread
 *
 * Arguments:
 *
 * Returns:
 ...
 *      VIP_ERROR    error registering signals
 *
 * Description:
 *  This function register the thread in a data structure so that
 *  when forking all these threads are stopped until all fork
 *  support actions are carried out.
 *
 ***********************************************************/
VAPI_ret_t EVAPI_register_thread(void);


/**********************************************************
 * 
 * Function: EVAPI_deregister_thread
 *
 * Arguments:
 *  pid(in) The pid of the thread to be registered
 *
 * Returns:
 *      VIP_OK pid was succesfully deregistered
 *      VIP_EINVAL_PARAM  pid not found
 *
 ***********************************************************/
VAPI_ret_t EVAPI_deregister_thread(void);
