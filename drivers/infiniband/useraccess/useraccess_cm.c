/*
  ...
  $Id: useraccess_cm.c,v 1.20 2004/02/25 01:04:49 roland Exp $
*/
                      ...
                      )
{
  ...
  tTS_IB_CM_COMM_ID comm_id;
  tTS_IB_CM_USER_CONNECTION cm_conn;
  tTS_IB_PATH_RECORD_STRUCT primary_path, alternate_path;
  tTS_IB_QP_ATTRIBUTE_STRUCT qp_attr;
  int rc, ret;
  VAPI_ret_t status;
...
#endif
{
  ...
  case TS_IB_IOCCMALTPATHLOAD:
             ...
             "load alternate path ioctl");
    {
      ...
      struct tTS_IB_PATH_RECORD_STRUCT path_record;
