/*
  ...
  $Id: ts_ib_cm_types.h,v 1.5 2004/02/25 00:32:31 roland Exp $
*/
...
#if !defined(TS_EMPTY_STRUCT)
#  ifdef W2K_OS
#    define TS_EMPTY_STRUCT void *reserved;
#  else
#    define TS_EMPTY_STRUCT
#  endif
#endif
...
typedef struct tTS_IB_CM_ACTIVE_PARAM_STRUCT tTS_IB_CM_ACTIVE_PARAM_STRUCT,
  *tTS_IB_CM_ACTIVE_PARAM;
typedef struct tTS_IB_CM_PASSIVE_PARAM_STRUCT tTS_IB_CM_PASSIVE_PARAM_STRUCT,
  *tTS_IB_CM_PASSIVE_PARAM;
typedef struct tTS_IB_CM_REQ_RECEIVED_PARAM_STRUCT tTS_IB_CM_REQ_RECEIVED_PARAM_STRUCT,
  *tTS_IB_CM_REQ_RECEIVED_PARAM;
typedef struct tTS_IB_CM_REP_RECEIVED_PARAM_STRUCT tTS_IB_CM_REP_RECEIVED_PARAM_STRUCT,
  *tTS_IB_CM_REP_RECEIVED_PARAM;
typedef struct tTS_IB_CM_LAP_RECEIVED_PARAM_STRUCT tTS_IB_CM_LAP_RECEIVED_PARAM_STRUCT,
  *tTS_IB_CM_LAP_RECEIVED_PARAM;
typedef struct tTS_IB_CM_APR_RECEIVED_PARAM_STRUCT tTS_IB_CM_APR_RECEIVED_PARAM_STRUCT,
  *tTS_IB_CM_APR_RECEIVED_PARAM;
typedef struct tTS_IB_CM_ESTABLISHED_PARAM_STRUCT tTS_IB_CM_ESTABLISHED_PARAM_STRUCT,
  *tTS_IB_CM_ESTABLISHED_PARAM;
typedef struct tTS_IB_CM_DISCONNECTED_PARAM_STRUCT tTS_IB_CM_DISCONNECTED_PARAM_STRUCT,
  *tTS_IB_CM_DISCONNECTED_PARAM;
typedef struct tTS_IB_CM_IDLE_PARAM_STRUCT tTS_IB_CM_IDLE_PARAM_STRUCT,
  *tTS_IB_CM_IDLE_PARAM;

struct tTS_IB_CM_ACTIVE_PARAM_STRUCT {
  tTS_IB_QP_HANDLE qp;
...
struct tTS_IB_CM_PASSIVE_PARAM_STRUCT {
  tTS_IB_QP_HANDLE qp;
...
struct tTS_IB_CM_REQ_RECEIVED_PARAM_STRUCT {
  tTS_IB_CM_PASSIVE_PARAM_STRUCT accept_param;
...
struct tTS_IB_CM_REP_RECEIVED_PARAM_STRUCT {
  tTS_IB_QPN local_qpn;
  tTS_IB_QPN remote_qpn;
  void *     remote_private_data;
  int        remote_private_data_len;
...
struct tTS_IB_CM_LAP_RECEIVED_PARAM_STRUCT {
...
struct tTS_IB_CM_APR_RECEIVED_PARAM_STRUCT {
  uint8_t ap_status;
  uint8_t apr_info_len;
  void   *apr_info;
};

struct tTS_IB_CM_ESTABLISHED_PARAM_STRUCT {
  TS_EMPTY_STRUCT
};

struct tTS_IB_CM_DISCONNECTED_PARAM_STRUCT {
  tTS_IB_CM_DISCONNECTED_REASON reason;
};

struct tTS_IB_CM_IDLE_PARAM_STRUCT {
