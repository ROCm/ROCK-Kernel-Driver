/*
  ...
  $Id: ts_ib_core_types.h,v 1.12 2004/02/25 00:32:31 roland Exp $
*/
...
typedef struct tTS_IB_DEVICE_PROPERTIES_STRUCT tTS_IB_DEVICE_PROPERTIES_STRUCT,
  *tTS_IB_DEVICE_PROPERTIES;
typedef struct tTS_IB_DEVICE_PROPERTIES_SET_STRUCT tTS_IB_DEVICE_PROPERTIES_SET_STRUCT,
  *tTS_IB_DEVICE_PROPERTIES_SET;
typedef struct tTS_IB_PORT_PROPERTIES_STRUCT tTS_IB_PORT_PROPERTIES_STRUCT,
  *tTS_IB_PORT_PROPERTIES;
typedef struct tTS_IB_PORT_PROPERTIES_SET_STRUCT tTS_IB_PORT_PROPERTIES_SET_STRUCT,
  *tTS_IB_PORT_PROPERTIES_SET;
typedef struct tTS_IB_PATH_RECORD_STRUCT tTS_IB_PATH_RECORD_STRUCT,
  *tTS_IB_PATH_RECORD;
typedef struct tTS_IB_ADDRESS_VECTOR_STRUCT tTS_IB_ADDRESS_VECTOR_STRUCT,
  *tTS_IB_ADDRESS_VECTOR;
typedef struct tTS_IB_QP_LIMIT_STRUCT tTS_IB_QP_LIMIT_STRUCT,
  *tTS_IB_QP_LIMIT;
typedef struct tTS_IB_QP_CREATE_PARAM_STRUCT tTS_IB_QP_CREATE_PARAM_STRUCT,
  *tTS_IB_QP_CREATE_PARAM;
typedef struct tTS_IB_QP_ATTRIBUTE_STRUCT tTS_IB_QP_ATTRIBUTE_STRUCT,
  *tTS_IB_QP_ATTRIBUTE;
typedef struct tTS_IB_GATHER_SCATTER_STRUCT tTS_IB_GATHER_SCATTER_STRUCT,
  *tTS_IB_GATHER_SCATTER;
typedef struct tTS_IB_SEND_PARAM_STRUCT tTS_IB_SEND_PARAM_STRUCT,
  *tTS_IB_SEND_PARAM;
typedef struct tTS_IB_RECEIVE_PARAM_STRUCT tTS_IB_RECEIVE_PARAM_STRUCT,
  *tTS_IB_RECEIVE_PARAM;
typedef struct tTS_IB_CQ_ENTRY_STRUCT tTS_IB_CQ_ENTRY_STRUCT,
  *tTS_IB_CQ_ENTRY;
typedef struct tTS_IB_CQ_CALLBACK_STRUCT tTS_IB_CQ_CALLBACK_STRUCT,
  *tTS_IB_CQ_CALLBACK;
typedef struct tTS_IB_PHYSICAL_BUFFER_STRUCT tTS_IB_PHYSICAL_BUFFER_STRUCT,
  *tTS_IB_PHYSICAL_BUFFER;
typedef struct tTS_IB_FMR_POOL_PARAM_STRUCT tTS_IB_FMR_POOL_PARAM_STRUCT,
  *tTS_IB_FMR_POOL_PARAM;
typedef struct tTS_IB_ASYNC_EVENT_RECORD_STRUCT tTS_IB_ASYNC_EVENT_RECORD_STRUCT,
  *tTS_IB_ASYNC_EVENT_RECORD;
typedef struct tTS_IB_SM_PATH_STRUCT tTS_IB_SM_PATH_STRUCT,
  *tTS_IB_SM_PATH;
typedef struct tTS_IB_PORT_LID_STRUCT tTS_IB_PORT_LID_STRUCT,
  *tTS_IB_PORT_LID;
...
typedef enum {
  TS_IB_PORT_STATE_NOP    = 0,
  TS_IB_PORT_STATE_DOWN   = 1,
  TS_IB_PORT_STATE_INIT   = 2,
  TS_IB_PORT_STATE_ARMED  = 3,
  TS_IB_PORT_STATE_ACTIVE = 4
} tTS_IB_PORT_STATE;
...
typedef enum {
  TS_IB_TRANSPORT_RC          = 0,
  TS_IB_TRANSPORT_UC          = 1,
  TS_IB_TRANSPORT_RD          = 2,
  TS_IB_TRANSPORT_UD          = 3,
} tTS_IB_TRANSPORT;
...
typedef enum {
  ...
  TS_IB_GSI_QP,
  TS_IB_RAW_IPV6_QP,
  TS_IB_RAW_ETHERTYPE_QP
} tTS_IB_SPECIAL_QP_TYPE;

typedef enum {
  TS_IB_WQ_SIGNAL_ALL,
  TS_IB_WQ_SIGNAL_SELECTABLE
} tTS_IB_WQ_SIGNAL_POLICY;

typedef enum {
  TS_IB_QP_STATE_RESET,
  TS_IB_QP_STATE_INIT,
  TS_IB_QP_STATE_RTR,
  TS_IB_QP_STATE_RTS,
  TS_IB_QP_STATE_SQD,
  TS_IB_QP_STATE_SQE,
  TS_IB_QP_STATE_ERROR
} tTS_IB_QP_STATE;
...
struct tTS_IB_DEVICE_PROPERTIES_STRUCT {
...
struct tTS_IB_DEVICE_PROPERTIES_SET_STRUCT {
  tTS_IB_DEVICE_PROPERTIES_MASK valid_fields;
  tTS_IB_GUID                   system_image_guid;
};

struct tTS_IB_PORT_PROPERTIES_STRUCT {
  tTS_IB_MTU        max_mtu;
...
struct tTS_IB_PORT_PROPERTIES_SET_STRUCT {
...
struct tTS_IB_PATH_RECORD_STRUCT {
  tTS_IB_GID  dgid;
  tTS_IB_GID  sgid;
  tTS_IB_LID  dlid;
  tTS_IB_LID  slid;
...
struct tTS_IB_ADDRESS_VECTOR_STRUCT {
  int                service_level;
...
struct tTS_IB_QP_CREATE_PARAM_STRUCT {
  tTS_IB_QP_LIMIT_STRUCT  limit;
  tTS_IB_PD_HANDLE        pd;
...
struct tTS_IB_QP_ATTRIBUTE_STRUCT {
  ...
  int                          pkey_index;
  tTS_IB_PORT                  port;
  tTS_IB_ADDRESS_VECTOR_STRUCT address;
  uint8_t                      local_ack_timeout;
  int                          alt_pkey_index;
  tTS_IB_PORT                  alt_port;
  tTS_IB_ADDRESS_VECTOR_STRUCT alt_address;
...
struct tTS_IB_GATHER_SCATTER_STRUCT {
  uint64_t    address;
  uint32_t    length;
  tTS_IB_LKEY key;
};

struct tTS_IB_SEND_PARAM_STRUCT {
...
struct tTS_IB_RECEIVE_PARAM_STRUCT {
  tTS_IB_WORK_REQUEST_ID work_request_id;
...
struct tTS_IB_CQ_CALLBACK_STRUCT {
...
struct tTS_IB_PHYSICAL_BUFFER_STRUCT {
  uint64_t address;
  uint64_t size;
};

struct tTS_IB_FMR_POOL_PARAM_STRUCT {
...
struct tTS_IB_ASYNC_EVENT_RECORD_STRUCT {
...
struct tTS_IB_SM_PATH_STRUCT {
  tTS_IB_LID  sm_lid;
  tTS_IB_SL   sm_sl;
};

struct tTS_IB_PORT_LID_STRUCT {
  tTS_IB_LID lid;
  uint8_t    lmc;
};
