/*
  ...
  $Id: ts_ib_mad_types.h,v 1.7 2004/02/25 00:32:32 roland Exp $
*/
...
typedef struct tTS_IB_MAD_STRUCT tTS_IB_MAD_STRUCT, *tTS_IB_MAD;
typedef struct tTS_IB_MAD_FILTER_STRUCT tTS_IB_MAD_FILTER_STRUCT,
  *tTS_IB_MAD_FILTER;
...
struct tTS_IB_MAD_FILTER_STRUCT {
  tTS_IB_DEVICE_HANDLE     device;
  tTS_IB_PORT              port;
  tTS_IB_QPN               qpn;
  uint8_t                  mgmt_class;
