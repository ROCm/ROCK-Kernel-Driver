/*
  ...
  $Id: ts_kernel_hash.h,v 1.17 2004/02/25 00:22:36 roland Exp $
*/
...
#else
  tTS_HASH_NODE node;
  node = table->bucket[hash_val].first;
  while (node)
  {
    entry=(tTS_HASH_ENTRY) ((char*)node - offsetof(tTS_HASH_ENTRY_STRUCT,node));
