...
/**
 * kcl_drm_dsc_pps_payload_pack() - Populates the DSC PPS
 *
 * @pps_payload:
 ...
 */
void kcl_drm_dsc_pps_payload_pack(struct drm_dsc_picture_parameter_set *pps_payload,
...
EXPORT_SYMBOL(kcl_drm_dsc_pps_payload_pack);
#endif

#if !defined(HAVE_DRM_DSC_COMPUTE_RC_PARAMETERS)
/**
 * kcl_drm_dsc_compute_rc_parameters() - Write rate control
...
EXPORT_SYMBOL(kcl_drm_dsc_compute_rc_parameters);
#endif
