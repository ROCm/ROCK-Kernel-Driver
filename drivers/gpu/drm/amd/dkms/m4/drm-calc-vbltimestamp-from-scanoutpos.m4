...
AC_DEFUN([AC_AMDGPU_DRM_CALC_VBLTIMESTAMP_FROM_SCANOUTPOS],
	[AC_MSG_CHECKING([whether drm_calc_vbltimestamp_from_scanoutpos() use ktime_t arg])
	AC_KERNEL_TRY_COMPILE_SYMBOL([
		...
		AC_MSG_RESULT(yes)
		AC_DEFINE(HAVE_DRM_CALC_VBLTIMESTAMP_FROM_SCANOUTPOS_USE_KTIMER_T_ARG, 1, [drm_calc_vbltimestamp_from_scanoutpos() use ktime_t arg])
	], [
		AC_MSG_RESULT(no)
