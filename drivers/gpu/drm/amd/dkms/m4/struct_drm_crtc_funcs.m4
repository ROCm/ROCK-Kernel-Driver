...
dnl #
dnl # commit v4.8-rc1~62-79190ea26
dnl # drm: Add callbacks for late registering
dnl #
AC_DEFUN([AC_AMDGPU_STRUCT_DRM_CRTC_FUNCS_LATE_REGISTER], [
	AC_KERNEL_DO_BACKGROUND([
		AC_KERNEL_TRY_COMPILE([
			#include <drm/drm_crtc.h>
		], [
			struct drm_crtc_funcs *crtc_funcs = NULL;
			crtc_funcs->late_register(NULL);
		], [
			AC_DEFINE(HAVE_STRUCT_DRM_CRTC_FUNCS_LATE_REGISTER, 1, [
...
AC_DEFUN([AC_AMDGPU_STRUCT_DRM_CRTC_FUNCS], [
	...
	AC_AMDGPU_STRUCT_DRM_CRTC_FUNCS_LATE_REGISTER
])
