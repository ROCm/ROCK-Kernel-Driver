...
AC_DEFUN([AC_AMDGPU_NUM_ARGS_DRM_UNIVERSAL_PLANE_INIT], [
	...
	AC_KERNEL_TRY_COMPILE_SYMBOL([
		...
		AC_MSG_RESULT(yes)
		AC_DEFINE(HAVE_DRM_UNIVERSAL_PLANE_INIT_9ARGS, 1, [drm_universal_plane_init() wants 9 args])
	], [
		AC_MSG_RESULT(no)
		dnl #
		...
		AC_KERNEL_TRY_COMPILE_SYMBOL([
			...
			AC_MSG_RESULT(yes)
			AC_DEFINE(HAVE_DRM_UNIVERSAL_PLANE_INIT_8ARGS, 1, [drm_universal_plane_init() wants 8 args])
		], [
			AC_MSG_RESULT(no)
			dnl #
			...
			dnl #
			AC_DEFINE(HAVE_DRM_UNIVERSAL_PLANE_INIT_7ARGS, 1, [drm_universal_plane_init() wants 7 args])
		])
	])
])
