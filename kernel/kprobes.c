...
#else
int register_kprobe_user(struct kprobe *p) { return ENOSYS; }
void unregister_kprobe_user(struct kprobe *p) { }
int insert_kprobe_user(struct kprobe *p) { return ENOSYS; }
int remove_kprobe_user(struct kprobe *p) { return ENOSYS; }
#endif
