...
static const struct cpumask *xen_target_cpus(void)
{
...
static inline void _xen_send_IPI_mask(const struct cpumask *cpumask,
				      int vector, unsigned int excluded)
{
	unsigned int cpu;
	unsigned long flags;
...
static void xen_send_IPI_mask(const struct cpumask *cpumask, int vector)
{
	_xen_send_IPI_mask(cpumask, vector, -1);
}

static void xen_send_IPI_mask_allbutself(const struct cpumask *cpumask,
					 int vector)
{
