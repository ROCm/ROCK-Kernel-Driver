...
extern int Queue_Daemon_Command(void *request, unsigned long reqlen, void *data,
				...
				int interruptible);
extern int do_login(struct ncl_string * Server, struct ncl_string * Username, struct ncl_string * Password, void **lgnId, struct novfs_schandle Session);
...
extern int novfs_daemon_logout(struct qstr *Server,
